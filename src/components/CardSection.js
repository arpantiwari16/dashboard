...
export class CardSection extends Component {
    render() {
        return (
            <div>
                <div className="fs-1 text-center  fw-bold m-3 text-Capitalize"
                ...
                <div>
                    <div className=" text-center"
                        style={{ fontFamily: 'NHaasGroteskDSPro-65Md', overflow: 'visible', color: "darkblue", height: '2px', marginTop: "1%" }}><h5> Current
                            Price</h5></div>
                    <div className='text-success' style={{
                        fontFamily: 'NHaasGroteskDSPro-65Md', fontSize: '90px',
                        fontWeight: '700', color: "", textDecoration: 'none solid rgb(255, 255, 255)',
                        textAlign: 'center'
                    }}>
